			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="/admin/checkitineraryadd" method="POST" enctype="multipart/form-data">
							<fieldset>
								<button id="addibtn" type="button" class="btn btn-warning">一鍵輸入</button>
								<h2>填寫行程資料</h2>
							  <div class="control-group">
								<label class="control-label" for="title">活動標題 *</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="title" type="text" name="title" placeholder="xx一日遊" size="20" autofocus autocomplete="off">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="days" type="number" name="days"  placeholder="1" min="1" max="3" autofocus autocomplete="off">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <select id="selectError" data-rel="chosen" name="itype">
									<option value="城市探索">城市探索</option>
									<option value="花香風景">花香風景</option>
									<option value="山林徜徉">山林徜徉</option>
									<option value="海岸探索">海岸探索</option>
								  </select>
								</div>
							  </div>
							  ...
							  <div class="form-actions">
								<button id="ibtn" type="submit" class="btn btn-primary">送出</button>
