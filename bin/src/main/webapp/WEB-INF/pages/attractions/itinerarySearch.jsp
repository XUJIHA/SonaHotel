				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon white user"></i><span class="break"></span>查詢行程
							</h2>
							<div class="box-icon">
						...
						<div style="display: flex; margin:0;">
						    <a href="searchitinerary" id="searchitinerary" class="btn btn-primary m-5" role="button">行程總表</a>
						    <a href="additinerary" id="additinerary" class="btn btn-primary m-5" role="button">新增行程</a>
						    <a href="outputJsonI" id="outputJsonI" class="btn btn-primary m-5" role="button">JSON</a>
						    <a href="outputCsvI" id="outputCsvI" class="btn btn-primary m-5" role="button">CSV</a>
						    <a href="javascript:;" id="outputPdfI" class="btn btn-primary m-5" role="button">PDF</a>
						</div>
						<hr style="margin-top: -1px">
						<div class="box-content">
							<table class="table table-hover" id="iaccordion"></table>
						</div>
					</div>
					<!--/span-->
