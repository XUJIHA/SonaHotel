				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon white user"></i><span class="break"></span>查詢景點
							</h2>
							<div class="box-icon">
						...
						<div style="display: flex; margin:0;">
						    <a href="searchattractions" id="allattractions" class="btn btn-primary m-5" role="button">景點總表</a>
						    <a href="addattractions" id="addattractions" class="btn btn-primary m-5" role="button">新增景點</a>
						    <a href="outputJson" id="outputJson" class="btn btn-primary m-5" role="button">JSON</a>
						    <a href="outputCsv" id="outputCsv" class="btn btn-primary m-5" role="button">CSV</a>
						    <a href="javascript:;" id="outputPdf" class="btn btn-primary m-5" role="button">PDF</a>
						</div>
						<hr style="margin-top: -1px">
						<div class="box-content">
							<table class="table table-hover" id="accordion"></table>
						</div>
					</div>
					<!--/span-->
