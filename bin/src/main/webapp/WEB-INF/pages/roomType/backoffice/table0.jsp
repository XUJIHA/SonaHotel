	...
	<div class="container-fluid-full">
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>房型管理</h2>
						<div class="box-icon">
			...
			<div class="box-content">
						<table id="roomTable" style="width: 100%; table-layout: auto">
						  <thead>
							  <tr>
								  ...
								  <th style="text-align: center">房間設備</th>
						  ...
						  <c:forEach var="bean" items="${beans}" varStatus="status">
							<tr>
								...
								<td style="vertical-align: middle; text-align: center; width:15%">${bean.equipment} </td>
