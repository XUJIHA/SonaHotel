					...
					<div class="breadcrumb-text">
						...
						<div class="bt-option">
							<a href="showallroom.controller">顯示全部房型</a> <a
								href="showallroom.admin.controller">管理房型</a> <a
								href="insertroommain" id="insertBtn">新增房型</a><br>
							<hr>
							<c:choose>
								<c:when test="${row == 0}">
									<script>
	...
	<section class="rooms-section spad">
		<div class="container" id="target">
			...
			<form action="updateroom.controller" method="post"
				...
				<p>
					<label class="t1" for="">客房狀態: </label> <input type="radio"
						name="status" value="1"
						<c:if test="${bean.status==1}"><c:out value="checked"/></c:if>>空房
					<input type="radio" name="status" value="0"
						<c:if test="${bean.status==0}"><c:out value="checked"/></c:if>>使用中
				</p>
				<p>
					<label class="t1" for="">容納人數:</label>&nbsp;<input type="text"
						name="capacity" value="${bean.capacity}">
				</p>
				<p>
					<label class="t1" for="">床數:</label>&nbsp;<input type="text"
				...
				<p>
					<label class="t1" for="">設施: </label> <input type="checkbox"
						name="cbEquipment1" value="電視"
						<c:if test="${e0==1}"><c:out value="checked" /></c:if>>&nbsp;電視
					<input type="checkbox" name="cbEquipment2" value="沙發"
						<c:if test="${e1==1}"><c:out value="checked" /></c:if>>&nbsp;沙發
					<input type="checkbox" name="cbEquipment3" value="陽台"
						<c:if test="${e2==1}"><c:out value="checked" /></c:if>>&nbsp;陽台
					<input type="checkbox" name="cbEquipment4" value="三溫暖"
						<c:if test="${e3==1}"><c:out value="checked" /></c:if>>&nbsp;三溫暖
					<input type="checkbox" name="cbEquipment5" value="按摩椅"
						<c:if test="${e4==1}"><c:out value="checked" /></c:if>>&nbsp;按摩椅
					<input type="checkbox" name="cbEquipment6" value="吸菸房"
						<c:if test="${e5==1}"><c:out value="checked" /></c:if>>&nbsp;吸菸房
					<input type="checkbox" name="cbEquipment7" value="攜帶寵物"
						<c:if test="${e6==1}"><c:out value="checked" /></c:if>>&nbsp;攜帶寵物
					<input type="checkbox" name="cbEquipment8" value="按摩浴缸"
						<c:if test="${e7==1}"><c:out value="checked" /></c:if>>&nbsp;按摩浴缸
				</p>
				<p>
