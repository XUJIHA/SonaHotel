				...
				<div class="col-lg-12">
					<div class="breadcrumb-text">
						...
						<div class="bt-option">
							...
							<a href="showallroom.admin.controller" style="color: darkgray"><b>管理房型</b></a>
							<hr>
							<div class="parent123" style="justify-content: space-around;align-items: center;">
								<form action="insertroommain.controller" method="get">
									<input style="height:41px" type="submit" value="新增房型">
								</form>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

								<form action="searchroom.admin.controller" method="get">
									<select class="selection123" name="selection">
									...
									</select>&nbsp; <input style="height:41px" type="submit" value="查詢">
								</form>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<div style="display:inline-flex;">
								<label style="font-size: 23px">輸入房型ID 或 房名:</label>&nbsp;&nbsp;
								<form action="searchroom2.admin.controller" method="post">
									<input style="height:41px" type="text" name="findInput">&nbsp;
									<input style="height:41px" type="submit" value="查詢">
								</form></div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6">
						<div class="room-item">
							<img src="showroomimg.controller?roomId=${bean.roomId}"
								height="220px" alt="">
							<div class="ri-text">
								<span style="font-size: 26px"><b>${bean.name}</b>&nbsp;<i
									style="font-size: 18px">( ID : ${bean.roomId} )</i></span>
								<c:choose>
								...
								&nbsp;&nbsp;&nbsp;&nbsp; <br>
								<form style="display: inline" action="showupdateroom.controller"
									method="post">
									<input type="submit" value="修改"> <input name="roomId"
										value="${bean.roomId}" type="hidden">
								</form>
								&nbsp;
