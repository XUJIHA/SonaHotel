...
<body>
	...
	<form action="AddRestaurant.controller" method="post" enctype="multipart/form-data">
		<table align="center">
			<tr>
			...
			<tr>
				<td align="center">名子<input type="text" name="restaurantname"> <span
					style="color: red"><b>${nullError2}</b></span></td>
			</tr>
			<tr>
				<td align="center">簡介<input type="text" name="restaurantdes"> <span
					style="color: red"><b>${nullError3}</b></span></td>
			</tr>
			<tr>
				<td align="center">種類<input type="text" name="restauranttype"> <span
					style="color: red"><b>${nullError4}</b></span></td>
			</tr>
			<tr>
				<td align="center">價錢<input type="text"
					onkeyup="value=value.replace(/[^\d]/g,'') " name="restaurantprice">
					<span style="color: red"><b>${nullError5}</b></span></td>
			</tr>
			<tr>
				<td align="center">地址<input type="text" name="restaurantaddress"> <span
					style="color: red"><b>${nullError6}</b></span></td>
			</tr>
			<tr>
				<td align="center">電話<input type="text" name="restaurantphone"> <span
					style="color: red"><b>${nullError7}</b></span></td>
			</tr>
			<tr>
				<td align="center">座位數<input type="text"
...
<form action="Homepage.controller" method="get" >
	<div align="center">
		<input type="submit" value="回餐廳首頁" ">
	</div>
</form>
	<br>
	<br>
