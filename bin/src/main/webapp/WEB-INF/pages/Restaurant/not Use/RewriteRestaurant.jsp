...
<body>
	...
	<form action="RewriteRestaurant.controller" method="post"
		...
		<table align="center">
			...
			<tr>
				<td align="right"><input type="file" id="fileInput"
					name="image" multiple> <img id="preview" src=""
					alt="image preview"> <script>
