				...
				<div class="col-lg-10 offset-lg-1">
					<div class="blog-details-text">
						<div class="leave-comment">
							...
							<form style="font-size:20px"class="comment-form" action="users/searchorder.controller"
								method="POST">
								<div class="row">
									<div class="col-lg-6">
									...
									<div class="col-lg-6">
										金額:<input style="font-size:20px"readonly type="text" name="price"
									...
									<div class="col-lg-12 text-center">
										<button style="font-size:20px"type="submit" class="site-btn">訂單查詢</button>
									</div>
								</div>
