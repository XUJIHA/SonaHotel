...
<body>
					...
					<div class="box span12">
						...
						<div class="box-content">
							...
							<form id="form1" name="form1" method="post"
								action="/admin/giftinsert.controller" enctype="multipart/form-data">
								<table
									...
									<thead>
										<tr style="font-weight: blod; font-size: 25px;">
											...
											<th style="width: 33%">介紹</th>
											<th style="width: 18%">圖片</th>
											<th style="width: 10%">新增</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td><input type="text" class="inputbox" name="sno"
												id="sno" style="width: 60px; maxlength: 5px;"
												value="${requestScope.sno}"></td>
											<td><input type="text" class="inputbox" name="sname"
												id="sname" style="width: 190px;height:60px; "
												value="${requestScope.sname}"><br></td>


											<td><input type="text" class="inputbox" name="sprice"
												id="sprice" style="width: 60px; maxlength: 5px;"
												value="${requestScope.sprice}"></td>
											<td><input class="inputbox" name="snum" type="text"
												id="snum" style="width: 60px; maxlength: 4px;"
												value="${requestScope.snum}"></td><td><textarea name="sdes" type="text"
													style="width:350px;" id="sdes" cols="30" rows="8" value="${requestScope.sdes}"></textarea></td>

											<td
												style="table-layout: fixed; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
												<input
												class='InputClass' type="file" name="spic" size="40"
											...
											<td class="center">
												...
												<br>
												<br>
												<input style="border-style:none; background:#DEB948; color:white;font-size:20px;line-height:1.5em;" type="button" value='一 鍵 輸 入' id="inputform"/>
											</td>
	...
	<script >
	    ...
	    $('#inputform').on('click', function() {
	      ...
	      $('#sprice').val('288');
	      $('#snum').val('200');
	      $('#sdes').val('以花生壓磨製作，保留了花生的原始風味，香酥不甜膩，入口即化。');
	    });
	 
// 	$('#inputform').on('click',function(){
//         $('#sno').attr('value','0111')
//         $('#sname').attr('value','貢糖')
//         $('#sprice').attr('value','288')
//         $('#snum').attr('value','200')
//         $('#sdes').attr('value','以花生壓磨製作，保留了花生的原始風味，香酥不甜膩，入口即化。')
