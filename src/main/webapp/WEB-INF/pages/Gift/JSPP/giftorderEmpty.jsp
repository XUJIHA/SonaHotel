					...
					<div class="col-lg-6">
						<div class="tn-right">
							...
							<div class="language-option test">
                                    <span class="color"><a href="/logout"><i class="fa-solid fa-right-from-bracket" style="color: black"></i></a></span>
                            </div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-10 offset-lg-1">
					<div class="blog-details-text">
						<div class="leave-comment">
							...
							<form action="users/giftdisplay.controller" method="GET" class="comment-form">
								<div class="row">
									<div class="col-lg-12 text-center">
										<button type="submit" class="site-btn">立即購買</button>
