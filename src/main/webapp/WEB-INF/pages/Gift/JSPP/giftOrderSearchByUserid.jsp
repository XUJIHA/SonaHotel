	...
	<div class="offcanvas-menu-wrapper">
		...
		<nav class="mainmenu mobile-menu">
			<ul>
				...
				<li><a href="/users/giftdisplay.controller">伴手禮</a></li>
					...
					<div class="table-wrap">
						<table class="table table-striped table-hover" id="accordion"
							...
							<tbody>
								...
								<c:forEach var="order" items="${gorder}">
									<tr data-toggle="collapse" data-target="#collapseOne"
										aria-expanded="true" aria-controls="collapseOne">
										<th scope="row">${order.giftorderid}</th>
										<td>${order.orderdate}</td>
										<td>${order.totalamount}</td>
										<!-- 										<td><form action="users/usersorderDetail.controller" method="POST"> -->
										<!-- 												<button style="border: 0; background-color: transparent" -->
										<%-- 													type="submit" name="giftorderid" value="${order.giftorderid}"> --%>
										<!-- 													<i class="fa-solid fa-magnifying-glass"></i> -->
										<!-- 												</button> -->
										<!-- 											</form></td> -->
										<td><a
											href="<c:url value='/users/usersorderDetail.controller/${order.giftorderid}' />"
											 name="id">詳細內容</a></td>
										<td>
											<button style="border: 0; background-color: transparent"
												class="delete" type="submit" name="giftorderid"
												value="${order.giftorderid}">
