					...
					<div class="col-lg-6">
						<div class="tn-right">
							...
							<div class="language-option">
								<span class="color"><i
									class="fa-solid fa-right-from-bracket" style="font-size: 18px"
									id="delete" style="color: black"><script
											type="text/javascript" src="/js/logout.js"></script></i></span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-wrap">
						...
						<form action="users/mymembercenter.controller" method="GET"
							class="comment-form">
							<div class="row">
								<div class="col-lg-12 text-center">
									<p class="discountMsg">總共折扣了${discount} 元</p>
