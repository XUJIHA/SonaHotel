				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
								<form action="<c:url value='/admin/updategift/${bean.sid}'/>" method="post" enctype="multipart/form-data">
								<table class="table table-striped table-bordered bootstrap-datatable datatable" width="100%"  style="table-layout:fixed;  ">
								
									<thead style="font-weight: blod; font-size: 25px;">
										<tr >
											<th style="width: 6%">編號</th>
											<th style="width: 12%">名稱</th>
											<th style="width: 8%">訂價</th>
											<th style="width: 8%">數量</th>
											<th style="width: 40%">介紹</th>
...
<!-- 											<th>刪除</th> -->
									...
									<tbody  >
										<tr class="alltext">
											<td style="word-break:break-all;"><input type="text" class="inputbox" name="sno" style=" width: 60px;maxlength: 5px;"
												id="sno" value="${bean.sno}" ></td>
												
<!-- 											<td ><input type="text" class="inputbox" name="sname" style=" width: 130px; maxlength: 5px;" -->
<%-- 												id="sname" value="${bean.sname}"><br></td> --%>
											<td ><textarea  name="sname"  type="text"  style="width:150px;
											id="sname" cols="30"  rows="7" >${bean.sname}</textarea></td>
											
											<td ><input type="text" class="inputbox" name="sprice" style=" width: 80px; maxlength: 5px;"
												id="sprice" value="${bean.sprice}"></td>
												
											<td ><input class="inputbox" name="snum" type="text" style="width: 80px; maxlength: 5px;"
												id="snum" value="${bean.snum}"></td>
												
											<td ><textarea  name="sdes"  type="text"  style="width:430px;
											id="sdes" cols="30"  rows="15" >${bean.sdes}</textarea></td>
												
											<td style="table-layout:fixed; 
											   white-space:normal;  overflow:auto;">
												<img style="width:190px; border-radius: 30px;"
												src="${pageContext.request.contextPath}/admin/getsouimage.controller/${bean.sid}" />
												<br>
												<br>
												<input type="file" name="spic" style="style="word-break:break-all;">
<!-- 											 <input  class='InputClass'  type="file"  name="spic" size="40" style="overflow: hidden;"/>  -->
                      						</td>
											<td class="center" style="weight:5px;border: 0; background-color: transparent">
...
<!-- 											<td> -->
<%-- 												<button type="submit" class="delete" name="sid" value="${bean.sid}"> --%>
