...
<body>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content" style="padding-left: 120px; padding-top: 30px">
					...
					<div style="display: inline-flex;">
						...
						</label> <input type="text" id="roomId" name="roomId"><span
							style="color: red"><i>
					...
					<div style="display: inline-flex; padding-left: 12px">
						...
						<input type="radio" class="radio25" style="float: left" name="status" value="1" checked>空房 
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" class="radio25" name="status" value="0">使用中
					</div><br>
					<div style="display: inline-flex;">
						<label class="t1" for=""><i style="color: red">*&nbsp;</i>容納人數:
						</label> <input type="text" id="capacity" name="capacity"><span
							style="color: red"><i>
								&nbsp;&nbsp;${errors.capacityNull}${errors.capacityFormatError}</i></span>
					</div><br>
					<div style="display: inline-flex; padding-left: 12px">
						<label class="t1" for="">床數: </label> <input type="text" id="bed"
							name="bed"><span style="color: red"><i>
								&nbsp;&nbsp;${errors.bedFormatError}</i></span>
					</div><br>
					<div style="display: inline-flex; padding-left: 12px">
						<label class="t1" for="">坪數: </label> <input type="text"
							id="size" name="size"><span style="color: red"><i>
								&nbsp;&nbsp;${errors.sizeFormatError}</i></span>
					</div><br>
					<div style="display: inline-flex; padding-left: 12px">
						<label class="t1" for="">價格: </label> <input type="text"
							id="price" name="price"><span style="color: red"><i>
					...
					<div style="display: inline-flex; padding-left: 12px">
						<img src="" id="preImg" width="500px" alt="">
					</div><br>
					<br>
					<div style="display: inline-flex; padding-left: 12px">
						<label class="t1" for=""></label> 
						<input id="insertSubmit" type="submit" value="提交">&nbsp;&nbsp;&nbsp;&nbsp;
						<button id="oneClick">一鍵輸入</button>
					</div><br>
				</form>
	...
	$(function(){
		$('#oneClick').click(function(e){
			...
			$('#size').val('16.8');
			$('#price').val('2500');
			$('#cbEquipment1').prop('checked',true);
			$('#cbEquipment1').parent().attr('class','checked');
			$('#cbEquipment3').prop('checked',true);
			$('#cbEquipment3').parent().attr('class','checked');
			$('#cbEquipment4').prop('checked',true);
			$('#cbEquipment4').parent().attr('class','checked');
			$('#description').val('Demo測試');
