				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon white edit"></i><span class="break"></span>修改餐飲店
							</h2>
							<div class="box-icon">
						...
						<div class="box-content">
							<c:forEach var="resturant" items="${resturant}">
								<form class="form-horizontal"
									action="RewriteRestaurant.controller" method="post"
									enctype="multipart/form-data">
									<fieldset>
										<input type="hidden" value="${resturant.restaurantid}" name="restaurantid">
										<div class="control-group">
											...
											<div class="controls">
												<input class="input-xlarge focused" id="focusedInput"
													...
													value="${resturant.restaurantname }"><span
										...
										<div class="control-group">
											...
											<div class="controls">
												<input class="input-xlarge focused" id="focusedInput"
													type="text" name="restaurantdes"
													value="${resturant.restaurantdes }"><span
										...
										<div class="control-group">
											...
											<div class="controls">
												<input class="input-xlarge focused" id="focusedInput"
													type="text" name="restauranttype"
													value="${resturant.restauranttype }"><span
										...
										<div class="control-group">
											...
											<div class="controls">
												<input class="input-xlarge focused" id="focusedInput"
													...
													value="${resturant.restaurantprice }"><span
										...
										<div class="control-group">
											...
											<div class="controls">
												<input class="input-xlarge focused" id="focusedInput"
													type="text" name="restaurantaddress"
													value="${resturant.restaurantaddress }"><span
										...
										<div class="control-group">
											...
											<div class="controls">
												<input class="input-xlarge focused" id="focusedInput"
													type="number" min="0"
													onkeyup = "value=value.replace(/[^\d]/g,'')"  name="restaurantphone"
													value="${resturant.restaurantphone }"><span
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="file" id="fileInput" name="image" multiple value="${resturant.image}">
										...
										<label class="control-label" for="focusedInput">原始圖片</label>
