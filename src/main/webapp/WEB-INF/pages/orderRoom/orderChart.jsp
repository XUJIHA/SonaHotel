	...
	<div class="container-fluid-full">
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				<ul class="breadcrumb">
					<li style="font-size:20px"><i class="icon-home"></i> <a href="/admin/backgroundIndex.controller">首頁</a> <i class="icon-angle-right"></i></li>
					<li style="font-size:20px"><a href="#">訂單系統</a> <i class="icon-angle-right"></i></li>
					<li style="font-size:20px"><a href="/admin/orderchart.controller">訂單分析</a></li>
				</ul>
				<div class="row-fluid">
					<div id="num" class="span3 statbox purple" onTablet="span6" onDesktop="span3"></div>
					<div id="amount" class="span3 statbox green" onTablet="span6" onDesktop="span3"></div>
					<div id="member" class="span3 statbox blue noMargin" onTablet="span6" onDesktop="span3"></div>
					<div id="roomname"class="span3 statbox yellow" onTablet="span6" onDesktop="span3"></div>	
				</div>
				<div class="row-fluid sortable">
					...
					<div class="box span6"style="margin-left:0px;">
						<div class="box-header">
							<h2><i class="fa-solid fa-users"></i><span class="break"></span>近三個月訂單會員數長條圖</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
								<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
								<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
					...
					<div class="box span6">
						<div class="box-header">
							<h2><i class="fa-solid fa-bed"></i><span class="break"></span>近三個月訂單房型圓餅圖</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
								<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
								<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
	...
	$(function(){
		...
		$.ajax({
			...
			success:function(data){
				...
				var desiredOrdersamount = [ordermoney[ppreviousMonth], ordermoney[previousMonth], ordermoney[currentMonth]];
				var orderamount=ordermoney[ppreviousMonth]+ordermoney[previousMonth]+ordermoney[currentMonth];
				
				var desiredMembers=[ordermember[ppreviousMonth],ordermember[previousMonth],ordermember[currentMonth]];
				var memberamount=ordermember[ppreviousMonth]+ordermember[previousMonth]+ordermember[currentMonth]
				...
				var memberamount = [...new Set(result)];
			...
			var amount=$('#amount')
	        amount.append('<div class="number"><i class="fa-solid fa-sack-dollar"></i></div><div class="title">金額總計</div><div class="footer">'+orderamount+'</div></div>')
			...
			var myChart3 = new Chart(ctx3, {
			    ...
			    data: {
			        ...
			        datasets: [{
			            label: '會員',
			            data: membercounts,
			            backgroundColor: ['#1E90FF','#4169E1','#000080'],
			            fill: false,
			            borderColor: '#578EBE',
			        }]
			    },
			...
			var member=$('#member')
        	member.append('<div class="number"><i class="fa-solid fa-users"></i></div><div class="title">會員總計</div><div class="footer">'+memberamount.length+'</div></div>')
			...
			var myChart4 = new Chart(ctx4, {
			    ...
			    data: {
			        ...
			        datasets: [{
			            label: '房型',
			            data: roomValues,
			            backgroundColor: ["#ffff00","#ffef00","#ffe800","#ffd300","#ffda00","#ffca00","#ffb900","#ffb800","#ffa600","#ffa500"],
			            fill: false,
			            borderColor: '#DEB948',
			        }]
			    },
	        ...
	        roomname.append('<div class="number"><i class="fa-solid fa-bed"></i></div><div class="title">熱門房型</div><div class="footer">'+maxRoom+'</div></div>')
