...
<body>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<div class="span3 statbox purple" onTablet="span6" onDesktop="span3">
					...
					<div class="number">${loginCount}<i class="icon-arrow-up"></i></div>
				...
				<div class="span3 statbox blue noMargin" onTablet="span6" onDesktop="span3">
					<div class="boxchart">5,6,7,2,0,-4,-2,4,8,2,3,3,2</div>
					<div class="number">48<i class="icon-arrow-up"></i></div>
				...
				<div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
					...
					<div class="number">1<i class="icon-arrow-down"></i></div>
					<div class="title">visits</div>
					<div class="footer">
						<a href="#"> read full report</a>
					</div>
					...
					<div class="box span6">
						<div class="box-header" data-original-title>
							<h2><i class="halflings-icon white list-alt"></i><span class="break"></span>會員帳戶狀態</h2>
							<div class="box-icon">
					...
					<div class="box span6">
						<div class="box-header" data-original-title>
							<h2><i class="halflings-icon white list-alt"></i><span class="break"></span>男女比例圖</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
								<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
								<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
					...
					<div >
						<div class="box-header">
							<h2><i class="halflings-icon white list-alt"></i><span class="break"></span>註冊人數長條圖</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
								<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
								<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2013 <a href="downloads/janux-free-responsive-admin-dashboard-template/" alt="Bootstrap_Metro_Dashboard">SONA Responsive Dashboard</a></span>
...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      label: '# 每月註冊人數', //標籤
      data: [${january}, ${february},${march}, ${april}, ${may},${june},${july}, ${august}, ${september},${october},${november}, ${december}], //資料
      //圖表背景色
      backgroundColor: [
        'rgba(255, 99, 132, 0.2)',
        'rgba(54, 162, 235, 0.2)',
...
var statusChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      label: '# 會員帳戶狀態', //標籤
      data: [${enabledCount},${disabledCount},${unverifiedCount}], //資料
      //圖表背景色
      backgroundColor: [
    	  'rgba(255, 99, 132, 0.2)',
          'rgba(54, 162, 235, 0.2)',
