			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="checkedit${a.aid }" method="POST" enctype="multipart/form-data">
							<fieldset>
								<h2>填寫景點資料</h2>
							  <div class="control-group">
								<label class="control-label" for="name">景點名稱 *</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="name" type="text" name="aname" value="${a.aname }" placeholder="請輸入景點名稱" size="20" autofocus autocomplete="off">
								  <span class="help-inline error">${errors.name}</span>
								</div>
							  </div>
							  <div class="control-group">
							  	<label class="control-label" for="address">地址 *</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="address" type="text" name="address" value="${a.address }" placeholder="請輸入景點地址" size="20" autofocus autocomplete="off">
								  <span class="help-inline error">${errors.address}</span>
								</div>
							  </div>
							  <div class="control-group">
								  <label class="control-label" for="phone">電話 *</label>
									<div class="controls">
									  <input class="input-xlarge focused" id="phone" type="text" name="phone" value="${a.phone }" maxlength="10" placeholder="0200002222" autocomplete="off">
									  <span class="help-inline error">${errors.phone}</span>
									</div>
							  </div>
							  <div class="control-group">
							  	<label class="control-label" for="lng">經度 *</label>
								<div class="controls">
								  <input id="lng" type="text" name="lng" id="lng" maxlength="8" value="${a.lng }" placeholder="24.98563" autofocus autocomplete="off">
								  <span class="help-inline error">${errors.lng}</span>
								</div>
							  </div>
							  <div class="control-group">
							  	<label class="control-label" for="lat">經度 *</label>
								<div class="controls">
								  <input type="text" name="lat" id="lat" maxlength="9" value="${a.lat }" placeholder="121.22228" autocomplete="off">
								  <span class="help-inline error">${errors.lat}</span>
								</div>
							  </div>
							  <h2>景點營業時間</h2>
							  <div class="control-group">
							  	<label class="control-label" for="begin7">禮拜天</label>
								<div class="controls">
								  <input class="" id="begin7" type="text" name="begin7" value="${a.begin7 }"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end7" type="text" name="end7" value="${a.end7 }" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
							  	<label class="control-label" for="begin1">禮拜一</label>
								<div class="controls">
								  <input class="" id="begin1" type="text" name="begin1" value="${a.begin1 }"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end1" type="text" name="end1" value="${a.end1 }" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
							  	<label class="control-label" for="begin2">禮拜二</label>
								<div class="controls">
								  <input class="" id="begin2" type="text" name="begin2" value="${a.begin2 }"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end2" type="text" name="end2" value="${a.end2 }" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
							  	<label class="control-label" for="begin3">禮拜三</label>
								<div class="controls">
								  <input class="" id="begin3" type="text" name="begin3" value="${a.begin3 }"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end3" type="text" name="end3" value="${a.end3 }" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
							  	<label class="control-label" for="begin4">禮拜四</label>
								<div class="controls">
								  <input class="" id="begin4" type="text" name="begin4" value="${a.begin4 }"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end4" type="text" name="end4" value="${a.end4 }" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
							  	<label class="control-label" for="begin5">禮拜五</label>
								<div class="controls">
								  <input class="" id="begin5" type="text" name="begin5" value="${a.begin5 }"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end5" type="text" name="end5" value="${a.end5 }" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
							  	<label class="control-label" for="begin6">禮拜六</label>
								<div class="controls">
								  <input class="" id="begin6" type="text" name="begin6" value="${a.begin6 }"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end6" type="text" name="end6" value="${a.end6 }" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
  							  <div class="control-group hidden-phone">
							    <label class="control-label" for="introduction">介紹:(限150字內)</label>
							    <div class="controls">
								  <textarea class="cleditor introduction" id="introduction" name="introduction" rows="3">${a.introduction }</textarea>
							    ...
							    <div class="controls">
								  <input class="input-file uniform_on file1" id="file1" name="file1" type="file">
							    </div>
							    <div class="img-box col-lg-5" id="frames" style="display: inline"><!-- 存放預覽圖片 --></div>
							  </div>
							  <div class="form-actions">
								<button id="esubmit" type="submit" class="btn btn-primary">送出</button>
