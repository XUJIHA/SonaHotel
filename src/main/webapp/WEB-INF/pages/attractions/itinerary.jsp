...
<!-- 	</div> -->
    ...
    <section class="aboutus-section spad">
        <div class="container">
            <div class="row">
             	 <div class="col-lg-12">
                    <div class="itinerary-pagination">
                        <button id="iall" data-value="所有行程" name="所有行程">所有行程</button>
                        <button id="iv1" data-value="花香風景" name="花香風景">花香風景</button>
                        <button id="iv2" data-value="山林徜徉" name="山林徜徉">山林徜徉</button>
                        <button id="iv3" data-value="海岸探索" name="海岸探索">海岸探索</button>
                        <button id="iv4" data-value="城市探索" name="城市探索">城市探索</button>
                    </div>
                </div>
                <div class="container-fluid">
		            <div class="hp-itinerary-items">
		                <div class="row" id="itinerary-info"></div>
		            </div>
		        </div>
            </div>
        </div>
