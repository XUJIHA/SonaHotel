			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="checkadd" method="POST" enctype="multipart/form-data">
							<fieldset>
								<button id="addbtn" type="button" class="btn btn-warning">一鍵輸入</button>
								<h2>填寫景點資料</h2>
							  <div class="control-group">
								<label class="control-label" for="name">景點名稱 *</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="name" type="text" name="aname" placeholder="請輸入景點名稱" size="20" autofocus autocomplete="off">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="address" type="text" name="address"  placeholder="請輸入景點地址" size="20" autofocus autocomplete="off">
							  ...
							  <div class="control-group">
								  <label class="control-label" for="phone">電話 *</label>
									<div class="controls">
									  <input class="input-xlarge focused" id="phone" type="text" name="phone" maxlength="10" placeholder="0200002222" autocomplete="off">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input id="lng" type="text" name="lng" id="lng" maxlength="8" placeholder="24.98563" autofocus autocomplete="off">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input type="text" name="lat" id="lat" maxlength="9" placeholder="121.22228" autocomplete="off">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="" id="begin7" type="text" name="begin7" value="09:00 AM"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end7" type="text" name="end7" value="05:00 PM" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="" id="begin1" type="text" name="begin1" value="09:00 AM"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end1" type="text" name="end1" value="05:00 PM" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="" id="begin2" type="text" name="begin2" value="09:00 AM"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end2" type="text" name="end2" value="05:00 PM" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="" id="begin3" type="text" name="begin3" value="09:00 AM"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end3" type="text" name="end3" value="05:00 PM" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="" id="begin4" type="text" name="begin4" value="09:00 AM"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end4" type="text" name="end4" value="05:00 PM" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="" id="begin5" type="text" name="begin5" value="09:00 AM"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end5" type="text" name="end5" value="05:00 PM" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="" id="begin6" type="text" name="begin6" value="09:00 AM"/>
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
								<div class="controls">
								  <input class="" id="end6" type="text" name="end6" value="05:00 PM" />
								  <span class="help-inline error">${errors.serviceHour}</span>
								</div>
							  </div>
							    ...
							    <div class="controls">
								  <textarea class="cleditor introduction" id="introduction" name="introduction" rows="3"></textarea>
							  ...
							  <div class="form-actions">
								<button id="isubmit" type="submit" class="btn btn-primary">送出</button>
